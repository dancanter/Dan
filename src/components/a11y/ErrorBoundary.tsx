  ...
  render() {
    ...
    return (
      <main id="main" className="mx-auto max-w-[620px] px-4 pt-10 pb-24">
        <h1 className="mb-3 text-h1">This screen didn’t load</h1>
        ...
        <p className="mb-3 text-body font-medium">
          If you were looking for help with a symptom, don’t wait for this to be fixed:
        </p>
        <a
          href="tel:111"
          className="mb-2 flex min-h-[52px] w-full items-center justify-center rounded-xl border-2 border-alert px-4 text-lead font-semibold text-alert no-underline"
        >
          Call 111
        </a>
        <a
