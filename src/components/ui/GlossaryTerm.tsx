    ...
    <span ref={wrapper} className="relative inline">
      ...
      {open && (
        <span
          ...
          className="absolute left-0 top-full z-40 mt-1 block w-[min(300px,78vw)] rounded-lg border border-moss bg-mossp px-3 py-2.5 text-small font-normal not-italic leading-relaxed text-ink shadow-lg"
        >
