...
export function FirstVisitNote() {
  ...
  return (
    ...
    >
      <h2 id="first-visit" className="mb-1.5 font-display text-lead font-semibold">
        Before you start
      </h2>
      <p className="m-0 text-body leading-relaxed text-soft">
      ...
      <p className="mb-0 mt-2.5 text-body leading-relaxed text-soft">
      ...
      <button
        ...
        className="mt-3.5 min-h-11 w-full rounded-lg border border-line px-3 text-body font-semibold"
      >
        Got it
      </button>
    </section>
