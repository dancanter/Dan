  ...
  return (
    ...
    >
      <PromptCard
        ...
        prompt={<p className="m-0 text-lead leading-relaxed">{entry.definition}</p>}
        options={options}
        answer={entry.term}
        chosen={chosen}
        onChoose={setChosen}
        ...
        reveal={
          <>
            <p className="m-0 font-display text-title font-semibold first-letter:uppercase">
              {entry.term}
            </p>
            <p className="mt-1.5 text-body leading-relaxed">{entry.definition}</p>
