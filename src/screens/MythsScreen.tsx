  ...
  return (
    ...
    >
      <div className="rounded-xl border-[1.5px] border-line bg-card px-4 py-5">
        ...
        <p className="m-0 mb-5 font-display text-h2 font-semibold leading-snug">“{myth.claim}”</p>
        ...
        {!revealed ? (
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={() => answer('myth')}
              className="min-h-[52px] flex-1 rounded-xl border-[1.5px] border-line bg-paper px-4 text-read font-semibold hover:border-moss"
            >
              That’s a myth
            </button>
            <button
          ...
          <div className="reveal-in">
            ...
            {/* Never "wrong". Half of these are things a relative said with
                ...
                them helps nobody. */}
            <p className="mb-2 mt-2.5 text-body font-semibold">
              {agreed ? 'That’s right.' : 'This one catches a lot of people.'}
            </p>
            <p className="m-0 text-body leading-relaxed">{myth.explanation}</p>
