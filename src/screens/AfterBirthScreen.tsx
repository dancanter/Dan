  ...
  return (
    <main id="main" className="mx-auto max-w-[780px] px-4 pt-5 pb-24">
      <div className="mb-4 flex flex-wrap items-center gap-4">
        <div className="relative flex h-[92px] w-[92px] flex-none -rotate-4 flex-col items-center justify-center rounded-full border-[1.5px] border-clay bg-clayp">
          <span
            ...
            aria-hidden="true"
          />
          <b className="font-display text-hero leading-none text-clay">
            {days < 14 ? days : weeks}
          </b>
      ...
      <div className="rounded-xl border border-dashed border-moss bg-card p-4">
        <div className="flex flex-wrap gap-2">
          {MOODS.map((m) => (
            <button
              ...
              className={`min-h-11 rounded-lg border px-3.5 text-small font-semibold ${
        ...
        <p aria-live="polite" className="mt-3 mb-0 text-small text-mossd">
          {lowMood
        ...
        {lowMood && (
          <Link
            ...
            className="mt-2 inline-block font-mono text-meta text-clay underline"
          >
