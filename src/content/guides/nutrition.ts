...
export const nutritionGuides: Guide[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '**Listen to your body.** If your body doesn’t agree with a certain food, or it causes too much bloating and discomfort, it’s okay not to eat it — even if everyone says it’s healthy. It might not be for you.',
